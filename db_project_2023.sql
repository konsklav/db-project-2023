...
CREATE TABLE IF NOT EXISTS Teams (
    ...
    teams_name VARCHAR(255) NOT NULL UNIQUE,
    home_field_name VARCHAR(255) NOT NULL,
    history_description TEXT,
    home_wins INTEGER NOT NULL CHECK (home_wins >= 0) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS Games (
    ...
    home_teams_score INTEGER NOT NULL CHECK (home_teams_score >= 0) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS PlayerGameStatistics (
    ...
    red_cards INTEGER NOT NULL CHECK (red_cards >= 0) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS GameEvents (
    ...
    event_type VARCHAR(255) NOT NULL CHECK (UPPER(event_type) IN (UPPER('γκολ'), UPPER('ακυρωμένο γκολ'), UPPER('κόκκινη κάρτα'), UPPER('κίτρινη κάρτα'), UPPER('πέναλτι'), UPPER('κόρνερ')))
);
